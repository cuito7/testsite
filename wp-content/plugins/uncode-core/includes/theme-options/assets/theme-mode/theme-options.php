...
function custom_theme_options()
{
	...
	$media_display = array(
		...
		'choices' => array(
			...
			array(
				'value' => 'isotope',
				'label' => esc_html__('Isotope', 'uncode-core') ,
			) ,
		),
		'section' => 'uncode_%section%_section',
	...
	$footer_width = array(
		...
		'label' => esc_html__('Copyright area width', 'uncode-core') ,
		'desc' => esc_html__('Override the Copyright area width.' ,'uncode-core'),
		'type' => 'select',
		'choices' => array(
			array(
				'value' => '',
	...
	$custom_settings_one = array(
		...
		str_replace('%section%', 'post', $media_display),
		...
		str_replace('%section%', 'page', $media_display),
		...
		str_replace('%section%', 'portfolio', $media_display),
